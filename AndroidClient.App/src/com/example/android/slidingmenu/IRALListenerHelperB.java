...
public class IRALListenerHelperB {
	
	public static IRefreshAndLoadListener getIRALL1(final ContentFragmentB cfa){
	...
	public static IRefreshAndLoadListener getIRALL2(final ContentFragmentB cfa){
	...
	public static IRefreshAndLoadListener getIRALL3(final ContentFragmentB cfa){
	...
	public static IRefreshAndLoadListener getIRALL4(final ContentFragmentB cfa){
